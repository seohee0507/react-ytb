    ...
    <section id='today' className={loadingClass}>
      <div className='today__inner'>
        <div className="today__thumb play__icon">
          <Link to={`/video/${todayText[0].id.videoId}`}>
            <img src={todayText[0].snippet.thumbnails.medium.url&&todayText[0].snippet.thumbnails.medium.url} alt={todayText[0].snippet.title} />
          </Link>
        </div>
        <div className="today__text">
          <span className="today">Today</span>
          <h3 className="title">
            <Link to={`/video/${todayText[0].id.videoId}`}>{todayText[0].snippet.title}</Link>
          </h3>
